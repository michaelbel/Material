...
import org.michaelbel.material.widget2.PatternView;
...
public class PatternViewFragment extends Fragment {
    ...
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup vGroup, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_pattern, vGroup, false);

        FrameLayout layout = view.findViewById(R.id.frameLock);
        layout.setBackgroundColor(0xFF64B5F6);

        lockView = view.findViewById(R.id.patternLock);
