...
import org.michaelbel.material.widget2.NumberTextView;
...
public class NumberViewFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        numberTextView.setTextColor(Utils.getAttrColor(getContext(), R.attr.colorPrimary));
        numberTextView.setLayoutParams(LayoutHelper.makeFrame(getContext(), LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.CENTER_HORIZONTAL));
