...
public class EmptyCell extends BaseCell {
    ...
    public EmptyCell(Context context) {
        ...
        headerTextView.setLayoutParams(LayoutHelper.makeFrame(context, LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.START | Gravity.CENTER_VERTICAL, 16, 0, 16, 0));
    ...
    public EmptyCell setGravity(int gravity) {
        headerTextView.setLayoutParams(LayoutHelper.makeFrame(getContext(), LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, gravity | Gravity.CENTER_VERTICAL));
        return this;
    }
