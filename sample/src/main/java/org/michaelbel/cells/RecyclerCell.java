...
import org.michaelbel.material.widget2.MaskImageView;
...
public class RecyclerCell extends FrameLayout {
    ...
    public RecyclerCell(Context context) {
        ...
        imageView.setLayoutParams(LayoutHelper.makeFrame(context, 48, 48, Gravity.START | Gravity.CENTER_VERTICAL, 16, 0, 16, 0));
        addView(imageView);
        ...
        textView1.setLayoutParams(LayoutHelper.makeFrame(context, LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.START | Gravity.TOP, 80, 10, 21, 0));
        addView(textView1);
        ...
        textView2.setLayoutParams(LayoutHelper.makeFrame(context, LayoutHelper.WRAP_CONTENT, LayoutHelper.WRAP_CONTENT, Gravity.START | Gravity.BOTTOM, 80, 0, 21, 10));
        addView(textView2);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        super.onMeasure(MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(widthMeasureSpec), MeasureSpec.EXACTLY), MeasureSpec.makeMeasureSpec(Utils.dp(getContext(), 64) + (divider ? 1 : 0), MeasureSpec.EXACTLY));
    }
