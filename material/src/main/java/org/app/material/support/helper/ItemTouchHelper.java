...
package org.app.material.support.helper;
...
import org.app.material.support.LinearLayoutManager;
import org.app.material.support.RecyclerView;
import org.app.material.support.RecyclerView.OnItemTouchListener;
import org.app.material.support.RecyclerView.ViewHolder;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (mRecyclerView != null) {
            ...
            mSwipeEscapeVelocity = AndroidUtilities.dp(recyclerView.getContext(), 120);
            mMaxSwipeVelocity = AndroidUtilities.dp(recyclerView.getContext(), 800);
            setupCallbacks();
        }
    }
    ...
    public abstract static class Callback {
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (mCachedMaxScrollSpeed == -1) {
                mCachedMaxScrollSpeed = AndroidUtilities.dp(recyclerView.getContext(), 20);
            }
