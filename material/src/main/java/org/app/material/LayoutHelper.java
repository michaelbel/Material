...
public class LayoutHelper {
    ...
    public static FrameLayout.LayoutParams createScroll(int width, int height) {
    ...
    public static RelativeLayout.LayoutParams createRelative(float width, float height, int leftMargin, int topMargin, int rightMargin, int bottomMargin, int alignParent, int alignRelative, int anchorRelative) {
        ...
        layoutParams.leftMargin = DimenUtil.dp(leftMargin);
        layoutParams.topMargin = DimenUtil.dp(topMargin);
        layoutParams.rightMargin = DimenUtil.dp(rightMargin);
        layoutParams.bottomMargin = DimenUtil.dp(bottomMargin);
        return layoutParams;
    }
}