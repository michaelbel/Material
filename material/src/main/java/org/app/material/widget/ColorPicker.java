...
public class ColorPicker extends View {
    ...
    public ColorPicker(Context context) {
        ...
        mColorWheelThickness = AndroidUtilities.dp(context, 8);
        mColorWheelRadius = AndroidUtilities.dp(context, 124);
        mPreferredColorWheelRadius = mColorWheelRadius;
        mColorCenterRadius = AndroidUtilities.dp(context, 54);
        mPreferredColorCenterRadius = mColorCenterRadius;
        mColorCenterHaloRadius = AndroidUtilities.dp(context, 60);
        mPreferredColorCenterHaloRadius = mColorCenterHaloRadius;
        mColorPointerRadius = AndroidUtilities.dp(context, 14);
        mColorPointerHaloRadius = AndroidUtilities.dp(context, 18);
